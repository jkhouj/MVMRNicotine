# Script to run MR Egger SIMEX. Created by Jasmine Khouja 31/05/2022.
...
BetaXG <- dat_COT_never$beta.exposure
BetaYG <- dat_COT_never$beta.outcome
seBetaXG <- dat_COT_never$se.exposure
seBetaYG <- dat_COT_never$se.outcome
...
output<-cbind(
  ...
  lcior2, 
  ucior2)
simexegger_COTn <-rbind(simexegger, output)
colnames(simexegger_COTn) <- c(
  "Exposure", 
  "beta_weighted", 
  "lowerCI_weighted", 
  "upperCI_weighted", 
...
BetaXG <- dat_COT_ever$beta.exposure
BetaYG <- dat_COT_ever$beta.outcome
seBetaXG <- dat_COT_ever$se.exposure
seBetaYG <- dat_COT_ever$se.outcome
...
output<-cbind(
  ...
  lcior2, 
  ucior2)
simexegger_COTe <-rbind(simexegger, output)
colnames(simexegger_COTe) <- c(
  "Exposure", 
  "beta_weighted", 
  "lowerCI_weighted", 
  "upperCI_weighted", 
...
################################################################################
  ...
  BetaXG <- dat_COT_never_5e6$beta.exposure
  BetaYG <- dat_COT_never_5e6$beta.outcome
  seBetaXG <- dat_COT_never_5e6$se.exposure
  seBetaYG <- dat_COT_never_5e6$se.outcome
  ...
  output<-cbind(
    ...
    lcior2, 
    ucior2)
  simexegger_COTn5e6 <-rbind(simexegger, output)
  colnames(simexegger_COTn5e6) <- c(
    "Exposure", 
    "beta_weighted", 
    "lowerCI_weighted", 
    "upperCI_weighted", 
  ...
  BetaXG <- dat_COT_ever_5e6$beta.exposure
  BetaYG <- dat_COT_ever_5e6$beta.outcome
  seBetaXG <- dat_COT_ever_5e6$se.exposure
  seBetaYG <- dat_COT_ever_5e6$se.outcome
  ...
  output<-cbind(
    ...
    lcior2, 
    ucior2)
  simexegger_COTe5e6 <-rbind(simexegger, output)
  colnames(simexegger_COTe5e6) <- c(
    "Exposure", 
    "beta_weighted", 
    "lowerCI_weighted", 
    "upperCI_weighted", 
